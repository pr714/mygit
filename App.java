...
public class App {
	...
	public static void main(String[] args) {
		...
		Employee em1 = new Employee(120,"Mary Smith", 25);
		Employee em2 = new Employee(121,"John Aces", 32);
		Employee em3 = new Employee(123,"Ian Young", 29);
...
//		List<Employee> employees = (List<Employee>) session.load(Employee.class,new Integer(39));
	...
	public static void readload() {
		Session session = getSessionFactory().openSession();
		@SuppressWarnings("unchecked")
		Object employee = session.load(Employee.class,new Integer(39));
		Employee emp=(Employee)employee;
		System.out.println("Found " + emp.getName() + " Employees");
		session.close();
